...
@interface ManualCreateXiaoRui ()<UITextFieldDelegate>
...
@end
@implementation ManualCreateXiaoRui
+ (instancetype)shareManualCreateXiaoRui
{
...
- (IBAction)backgroundButton:(UIButton *)sender {
	...
	[self.deviceUIDFiled resignFirstResponder];
