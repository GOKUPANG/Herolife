...
//	NSLog(@"userInfo%@", NSStringFromClass([userInfo class]));
	id alert = [userInfo valueForKeyPath:@"alert"];
	
//	NSLog(@"alert-%@", alert);
//	NSLog(@"alertclass%@", NSStringFromClass([alert class]));
	self.content_label.text = alertstr;
