...
- (void)setupActionSheetView {
  ...
  //  _actionSheetView.backgroundColor = kActionSheetViewColor; 斌修改
    
    _actionSheetView.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.2];
   ...
   // UIImage *highlightedImage = [self imageWithColor:[UIColor redColor]];
    ...
    if (_otherButtonTitles && _otherButtonTitles.count > 0) {
        for (int i = 0; i < _otherButtonTitles.count; i++) {
            ...
            otherBtn.tag = i;
            otherBtn.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.3];
            ...
            //斌修改 [otherBtn setBackgroundImage:normalImage forState:UIControlStateNormal];
           
          // 斌修改 [otherBtn setBackgroundImage:highlightedImage forState:UIControlStateHighlighted];
   ...
   // cancelBtn.backgroundColor = [UIColor whiteColor];
    ...
    cancelBtn.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.3];
